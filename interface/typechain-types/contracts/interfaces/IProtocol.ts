...
export interface IProtocolInterface extends utils.Interface {
  functions: {
    ...
    "rateOfLiquidity()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "rateOfLiquidity",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface IProtocol extends BaseContract {
  ...
  functions: {
    ...
    rateOfLiquidity(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    rateOfLiquidity(overrides?: CallOverrides): Promise<PopulatedTransaction>;
